...
if (!fs.existsSync(jsonFile)) {
    productManager.addProduct("botas","Botas negras de cuero",29.30,"urldelaimagen","pp3499",56);
    productManager.addProduct("camisa","camisa de lana clase A",29.30,"urldelaimagen1","39995asd",56);   
    productManager.addProduct("camisa","camisa de lana clase B",10.75,"urldelaimagen2","2435asd",56);   
    productManager.addProduct("sueter","Sueter de lana clase B",25,"urldelaimagen3","rrr35as",5);       
    productManager.addProduct("casco","casco de ciclismo Mips",33.50,"urldelaimagen4","2445asd",80);    
